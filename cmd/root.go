...
import (
	"fmt"
	"github.com/renfy96/yy/internal/command/create"
	"github.com/renfy96/yy/internal/command/project"
	"github.com/renfy96/yy/internal/command/run"
	"github.com/renfy96/yy/internal/command/upgrade"
	"github.com/renfy96/yy/internal/command/wire"
	"github.com/spf13/cobra"
)

var rootCmd = &cobra.Command{
	Use:     "yy",
	Example: "yy new demo-api",
